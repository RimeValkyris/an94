...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
  ...
  return (
    <div
      ...
      ref={containerRef}
    >
      {/* Hidden header section - using parent component title instead */}
      ...
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
          ...
          >
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
              <div className="h-10 absolute left-3 md:left-3 w-10 rounded-full bg-black border-2 border-white flex items-center justify-center">
                <div className="h-4 w-4 rounded-full bg-white border border-gray-300 p-2" />
              </div>
        ...
        <div
          ...
          className="absolute md:left-8 left-8 top-0 overflow-hidden w-[4px] bg-transparent z-10"
        >
          <motion.div
            style={{
            ...
            className="absolute inset-x-0 top-0 w-[4px] bg-white shadow-lg z-20"
